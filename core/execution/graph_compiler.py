...
from ._state_graph_impl import _SimpleStateGraphImpl
...
def compile_v3_graph() -> _SimpleStateGraphImpl[AgentState]:
    """Build and compile the multi-agent execution graph."""
    sg = _SimpleStateGraphImpl[AgentState]()
    ...
    def _check_verification(s: AgentState):
        any_fail = any(
    ...
    def _check_review(s: AgentState):
